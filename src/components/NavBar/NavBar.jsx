...
const NavBar = () => {
  ...
  const navbarClasses = cn(
    'fixed top-0 inset-x-0 z-40 transition-all duration-300 backdrop-blur-md',
    {
    ...
    <header className={navbarClasses}>
      <div className='container max-w-7xl mx-auto px-4 sm:px-6 flex justify-between py-4'>
        ...
        <div className='flex justify-between items-center space-x-4'>
          ...
          <button onClick={() => setShowMobileMenu(!showMobileMenu)} className='block sm:hidden'aria-label="Toggle-Menu">
            {
